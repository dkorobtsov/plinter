    ...
    public static class Builder {
        ...
        public Request build() {
            if (numberOfClientsInitialized == 0 || numberOfClientsInitialized > 1) {
                throw new IllegalArgumentException("You can only initialize one client in the builder. " +
        ...
        private Request buildFromOkhttp() {
            ...
            if (permitsRequestBody(this.okhttpRequest.method())) {
                builder.method(this.okhttpRequest.method(), convertOkhttpRequestBodyTo3(this.okhttpRequest));
            } else {
