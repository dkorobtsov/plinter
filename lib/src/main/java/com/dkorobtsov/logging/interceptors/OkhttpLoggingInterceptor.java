...
public class OkhttpLoggingInterceptor implements Interceptor {
  ...
  public Response intercept(Chain chain) throws IOException {
    ...
    final long responseTime = TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - requestStartTime);
    ...
    ResponseDetails responseDetails = ResponseDetails.from(requestDetails, convertOkhttpResponseTo3(response), responseTime, isFileRequest(subtype));
