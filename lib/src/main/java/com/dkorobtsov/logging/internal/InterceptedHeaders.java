...
public final class InterceptedHeaders {
     ...
     * same casing, in the same order. Note that two headers instances may be <i>semantically</i>
     * equal but not equal according to this method. In particular, none of the following sets of
     * headers
    ...
    public static final class Builder {
         ...
         * field is found, the existing values are replaced.
         */
